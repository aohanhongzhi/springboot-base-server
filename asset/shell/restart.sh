...
nohup java -jar /media/data/eric/app/print-user/print-server-0.0.1-SNAPSHOT.jar --spring.profiles.active=prod  -Xmx1G -Xms512M -server -XX:+UseG1GC -XX:+HeapDumpOnOutOfMemoryError >>/media/data/eric/app/print-user/print.log  2>&1 &
